...
Nếu có nhiều symbol trùng tên ở nhiều file, thêm candidates
...
Dùng \_helpers: chỉ lấy các quan hệ code thật như CALLS, IMPORTS, EXTENDS, OVERRIDES, CONTAINS, HAS_METHOD
